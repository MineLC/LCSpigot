...
public abstract class BaseUserAuthentication implements UserAuthentication {
   ...
   public void loadFromStorage(Map<String, Object> credentials) {
      ...
      if (credentials.containsKey("userProperties")) {
         try {
            ...
            while(i$.hasNext()) {
               Map<String, String> propertyMap = (Map)i$.next();
   ...
   public Map<String, Object> saveForStorage() {
      ...
      if (!this.getUserProperties().isEmpty()) {
         ...
         Iterator i$ = this.getUserProperties().values().iterator();

         while(i$.hasNext()) {
            Property userProperty = (Property)i$.next();
      ...
      if (selectedProfile != null) {
         ...
         List<Map<String, String>> properties = new ArrayList();
         Iterator i$ = selectedProfile.getProperties().values().iterator();

         while(i$.hasNext()) {
            Property profileProperty = (Property)i$.next();
            Map<String, String> property = new HashMap();
