...
public class JsonList<K, V extends JsonListEntry<K>> {
    ...
    public JsonList(File file) {
        Logger.info("CREANDO ARCHIVO: " + file.getAbsolutePath());
        this.c = file;
    ...
    public void load() throws FileNotFoundException {
        ...
        {
            Logger.warn("Unable to find file {0}, creating it.", this.c );
        } catch ( com.google.gson.JsonSyntaxException ex )
        {
            Logger.warn("Unable to read file {0}, backing it up to {0}.backup and creating new copy.", this.c );
