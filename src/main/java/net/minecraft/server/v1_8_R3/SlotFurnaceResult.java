...
public class SlotFurnaceResult extends Slot {
    ...
    protected void c(ItemStack itemstack) {
        ...
        if (!this.a.world.isClientSide) {
            ...
            FurnaceExtractEvent event = new FurnaceExtractEvent(player, block, org.bukkit.craftbukkit.v1_8_R3.util.CraftMagicNumbers.getMaterial(itemstack.getItem()), itemstack.count, i);
