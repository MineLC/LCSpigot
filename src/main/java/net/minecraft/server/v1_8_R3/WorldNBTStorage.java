    ...
    public NBTTagCompound load(EntityHuman entityhuman) {
        ...
        try {
            ...
            if ( !file.exists() )
            {
                ...
                {
                    usingWrongFile = true;
                    Logger.warn( "Using offline mode UUID file for player " + entityhuman.getName() + " as it is the only copy we can find." );
                }
            }
            // Spigot End
            ...
            Logger.warn("Failed to load player data for " + entityhuman.getName());
        }
