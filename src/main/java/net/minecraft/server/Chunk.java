...
public class Chunk {
    ...
    public void a(Entity entity) {
        ...
        if (i != this.locX || j != this.locZ) {
            // CraftBukkit start
            Logger.warn("Wrong location for " + entity + " in world '" + world.getWorld().getName() + "'!");
            // Chunk.c.warn("Wrong location! (" + i + ", " + j + ") should be (" + this.locX + ", " + this.locZ + "), " + entity, new Object[] { entity});
            Logger.warn("Entity is at " + entity.locX + "," + entity.locZ + " (chunk " + i + "," + j + ") but was stored in chunk " + this.locX + "," + this.locZ);
            // CraftBukkit end
            entity.die();
        }
    ...
    public void a(ChunkSection[] achunksection) {
        if (this.sections.length != achunksection.length) {
            Logger.warn("Could not set level chunk sections, array length is " + achunksection.length + " instead of " + this.sections.length);
        } else {
    ...
    public void a(byte[] abyte) {
        if (this.e.length != abyte.length) {
            Logger.warn("Could not set level chunk biomes, array length is " + abyte.length + " instead of " + this.e.length);
        } else {
    ...
    public void a(int[] aint) {
        if (this.heightMap.length != aint.length) {
            Logger.warn("Could not set level chunk heightmap, array length is " + aint.length + " instead of " + this.heightMap.length);
        } else {
