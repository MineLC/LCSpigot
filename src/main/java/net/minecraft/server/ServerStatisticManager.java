    ...
    public void a() {
        if (this.d.isFile()) {
            try {
                ...
                Logger.error("Couldn\'t read statistics file " + this.d, ioexception);
            } catch (JsonParseException jsonparseexception) {
                Logger.error("Couldn\'t parse statistics file " + this.d, jsonparseexception);
            }
        }
        ...
        if (!jsonelement.isJsonObject()) {
            ...
            while (iterator.hasNext()) {
                ...
                if (statistic != null) {
                    ...
                    if (((JsonElement) entry.getValue()).isJsonPrimitive() && ((JsonElement) entry.getValue()).getAsJsonPrimitive().isNumber()) {
                        ...
                        if (jsonobject1.has("progress") && statistic.l() != null) {
                            try {
                                ...
                                Logger.warn("Invalid statistic progress in " + this.d, throwable);
                            }
                        }
                    }
                    ...
                    Logger.warn("Invalid statistic in " + this.d + ": Don\'t know what " + (String) entry.getKey() + " is");
                }
            }
        ...
        while (iterator.hasNext()) {
            ...
            if (((StatisticWrapper) entry.getValue()).b() != null) {
                ...
                try {
                    ...
                    Logger.warn("Couldn\'t save statistic " + ((Statistic) entry.getKey()).e() + ": error serializing progress", throwable);
                }
