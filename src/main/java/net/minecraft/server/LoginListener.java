...
public class LoginListener implements PacketLoginInListener, IUpdatePlayerListBox {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try{
                        ...
                        Logger.warn("Exception verifying " + i.getName(), ex);
                    }
                }
            }).start();
            // Spigot end
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (LoginListener.this.i != null) {
                            ...
                            Logger.error("Username \'" + gameprofile.getName() + "\' tried to join with an invalid session"); // CraftBukkit - fix null pointer
                        }
    ...
    public class LoginHandler {
        ...
        public void fireEvents() throws Exception {
                            ...
                            // CraftBukkit end
                            Logger.info("UUID of player " + LoginListener.this.i.getName() + " is " + LoginListener.this.i.getId());
                            LoginListener.this.g = LoginListener.EnumProtocolState.READY_TO_ACCEPT;
        }
    }
    // Spigot end
